  ...
  return (
    <AppShell>
      <div className="flex items-start justify-between mb-2 gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Pipeline_Inspection_01</h1>
          <div className="text-sm text-gray-500 mt-1">Corrosion Detection — Video · 08 May 2025</div>
        </div>
        <button
          className="px-5 py-2.5 bg-white border border-[#2E9E8F] text-[#2E9E8F] text-xs font-semibold uppercase tracking-wide hover:bg-[#EEF2FF] transition-colors"
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard icon={Film} label="Video Duration" value="03:00" />
        <StatCard icon={Target} label="Frames Analysed" value="180 / 180" />
        <StatCard icon={AlertTriangle} label="Defects Detected" value="5" />
      </div>
      <div className="bg-white border border-[#E5E7EB] rounded-lg p-6">
        <h2 className="text-[18px] font-bold text-gray-900 mb-4">Project Information</h2>
        <div className="divide-y divide-[#F0F2F7]">
          <MetaRow label="Video File" value="pipeline_walk_01.mp4" />
          <MetaRow label="Uploaded" value="08 May 2025" />
          <MetaRow label="Status" value="Completed" />
          <MetaRow label="Model Used" value="Corrosion Detection — Video" />
          <MetaRow label="Duration" value="3 minutes" />
        </div>
      </div>
    </div>
  );
